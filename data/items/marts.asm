...
CeruleanMartClerkText::
	script_mart GREAT_BALL, POTION, REPEL, ANTIDOTE, BURN_HEAL, AWAKENING, PARLYZ_HEAL

UnusedBikeShopClerkText:: ; unreferenced
	script_mart BICYCLE

VermilionMartClerkText::
	script_mart GREAT_BALL, SUPER_POTION, ICE_HEAL, AWAKENING, PARLYZ_HEAL, REPEL
...
CeladonMart2FClerk1Text::
	script_mart ULTRA_BALL, SUPER_POTION, REVIVE, SUPER_REPEL, ANTIDOTE, BURN_HEAL, ICE_HEAL, AWAKENING, PARLYZ_HEAL
