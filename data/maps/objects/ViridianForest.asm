	...
	;const_export VIRIDIANFOREST_RARE_CANDY  ; Novo item adicionado
...
ViridianForest_Object:
	...
	;object_event  2, 32, SPRITE_POKE_BALL, STAY, NONE, TEXT_VIRIDIANFOREST_RARE_CANDY, RARE_CANDY  ; Novo item
