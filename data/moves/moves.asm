...
; Characteristics of each move.
	...
	move NIGHT_SHADE,  SPECIAL_DOWN_SIDE_EFFECT,    90, GHOST,        100, 10
	...
	move SMOG,         POISON_SIDE_EFFECT2,         20, POISON,        85, 20
	...
	move FLASH,        FLINCH_SIDE_EFFECT1,       	50, ELECTRIC,      70, 20
	...
	move EXPLOSION,    EXPLODE_EFFECT,             150, FIRE,         100,  5
