...
; Learnset
	db 8, HORN_ATTACK
	db 14, POISON_STING
	db 20, DOUBLE_KICK  ; Novo ataque para cobertura de Lutador
	db 23, THRASH
	db 30, BITE         ; Novo ataque para dano adicional e flinch
	db 39, EARTHQUAKE   ; Novo ataque Ground forte
	db 0
...
; Evolutions
	...
	db 0
; Learnset
	db 20, SMOG        ; Novo ataque Poison adicionado cedo
	db 30, POISON_GAS
	db 33, MINIMIZE
	db 37, SLUDGE
	db 42, HARDEN
...
; Evoluções
	...
	db 0
; Learnset
	db 15, ROCK_THROW    ; Adicionado para STAB Rock
	db 22, STOMP         ; Mantido
	db 35, TAIL_WHIP     ; Mantido, mas poderia ser trocado por Iron Tail
	db 40, FURY_ATTACK   ; Mantido
	db 45, EARTHQUAKE    ; Agora aprende cedo seu golpe mais forte
	db 50, HORN_DRILL    ; Mantido
	db 55, TAKE_DOWN     ; Mantido
	db 0
...
; Evolutions
	...
	db 0
; Learnset
	db 20, POISON_GAS   ; Novo ataque Poison adicionado cedo
	db 32, SLUDGE
	db 37, SMOKESCREEN
	db 40, SELFDESTRUCT
	db 45, VENOM_PINCER
...
; Evolutions
	db 0
; Learnset
	db 20, DISABLE      ; Impede o uso do último golpe do oponente
	db 25, MINIMIZE     ; Aumenta evasão, ótimo para táticas defensivas
	db 30, BODY_SLAM    ; STAB poderoso Normal, com chance de paralisia
	db 35, ICE_BEAM     ; Cobertura contra Dragão, Ground e Grass
	db 40, THUNDERBOLT  ; Contra Water e Flying-types
	db 45, FLAMETHROWER   ; Contra Grass, Bug e Ice
	db 55, REST         ; Recupera todo o HP, essencial para durabilidade
	db 0
...
; Learnset
	db 16, HYPNOSIS
	db 19, WATER_GUN
	db 22, DOUBLE_KICK  ; Novo ataque Lutador
	db 26, DOUBLESLAP
	db 33, BODY_SLAM
	db 38, SUBMISSION   ; Novo ataque Lutador
	db 41, AMNESIA
	db 49, HYDRO_PUMP
	db 0
...
; Learnset
	db 16, HYPNOSIS
	db 19, WATER_GUN
	db 22, DOUBLE_KICK  ; Mantém ataque Lutador da forma anterior
	db 30, LOW_KICK     ; Novo ataque Lutador
	db 38, SUBMISSION   ; Mantém Submission da forma anterior
	db 49, HYDRO_PUMP   ; Mantém seu golpe característico de Água
	db 0
...
; Learnset
	...
	db 35, AURORA_BEAM
	db 44, REST
	db 45, LIGHT_SCREEN ; Novo (suporte)
	db 50, ICE_BEAM
	db 56, TAKE_DOWN
	db 0
...
; Evolutions
	db 0
; Learnset
	db 20, SMOG        ; Mantém consistência com Grimer
	db 30, POISON_GAS
	db 33, MINIMIZE
	db 37, SLUDGE
	db 42, VENOM_PINCER
...
; Evolutions
	db 0
; Learnset
	db 30, BODY_SLAM    ; Forte STAB Normal, com chance de paralisia
	db 35, ICE_BEAM     ; Cobertura contra Dragão, Ground e Grass
	db 40, THUNDERBOLT  ; Cobertura contra Flying e Water
	db 45, FLAMETHROWER   ; Cobertura contra Grass, Bug e Ice
	db 55, LIGHT_SCREEN ; Aumenta a resistência a ataques especiais
	db 60, REFLECT      ; Aumenta a resistência a ataques físicos
	db 0
...
; Evolutions
	db 0
; Learnset
	db 20, POISON_GAS   ; Mantém consistência com Koffing
	db 34, SMOKESCREEN
	db 40, SLUDGE
	db 49, HAZE
	db 53, EXPLOSION
...
; Evolutions
	db 0
; Learnset
	db 20, BONE_CLUB   ; Novo ataque Ground adicionado cedo
	db 25, LEER
	db 33, FOCUS_ENERGY
	db 41, THRASH
...
; Evolutions
	db 0
; Learnset
	db 15, WATER_GUN     ; STAB inicial, útil no começo
	db 25, SWIFT         ; Ataque rápido e que nunca erra
	db 30, PSYCHIC_M     ; STAB secundário, ótimo contra Poison e Fighting
	db 35, BUBBLEBEAM    ; Alternativa a Water Gun, chance de reduzir Speed
	db 50, RECOVER       ; Cura metade do HP, essencial para durabilidade
	db 55, HYDRO_PUMP    ; STAB poderoso para finalizações
	db 60, LIGHT_SCREEN  ; Reduz dano de ataques especiais
	db 0
